...
export const useCharacterAttributes = () => {
  ...
  const { data: styles, isLoading: isLoadingStyles } = useGetStylesQuery(botType);
  const { data: ethnicities, isLoading: isLoadingEthnicities } = useGetEthnicitiesQuery(botType);
  const { data: eyeColors, isLoading: isLoadingEyeColors } = useGetEyeColorsQuery(botType);
  const { data: hairStyles, isLoading: isLoadingHairStyles } = useGetHairStylesQuery(botType);
  const { data: hairColors, isLoading: isLoadingHairColors } = useGetHairColorsQuery(botType);
  const { data: bodyTypes, isLoading: isLoadingBodyTypes } = useGetBodyTypesQuery(botType);
  const { data: clothings, isLoading: isLoadingClothings } = useGetClothingsQuery(botType);
  const { data: personalities, isLoading: isLoadingPersonalities } =
    useGetPersonalitiesQuery(botType);
  const { data: occupations, isLoading: isLoadingOccupations } = useGetOccupationsQuery(botType);
  ...
  const { data: breastSizes, isLoading: isLoadingBreastSizes } = useGetBreastSizesQuery();
  const { data: buttSizes, isLoading: isLoadingButtSizes } = useGetButtSizesQuery();
  const { data: orientations, isLoading: isLoadingOrientations } = useGetOrientationsQuery();
  const { data: educations, isLoading: isLoadingEducations } = useGetEducationsQuery();
  const { data: religions, isLoading: isLoadingReligions } = useGetReligionsQuery();
