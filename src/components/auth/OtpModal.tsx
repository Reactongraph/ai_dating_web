        ...
        <div>
          <OtpInput
            ...
            renderInput={props => (
              <input
                {...props}
                className="!w-10 md:!w-12 !h-10 md:!h-12 !bg-gray-2a text-white border-0 rounded-lg mx-1 text-center text-lg md:text-xl focus:ring-2 focus:ring-accent-cyan"
              />
            )}
            containerStyle="justify-center"
          />
          {errors.otp && (
            <p className="mt-2 text-[10px] md:text-sm text-red-500 text-center">{errors.otp.message}</p>
          )}
        </div>
