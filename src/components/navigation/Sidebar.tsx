  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-2">
        ...
        <Link
          href="/wallet"
          className={`flex items-center ${isActive('/wallet') ? 'text-white bg-white-1a' : 'text-text-secondary'} hover:text-white group rounded-xl transition-colors ${
            isExpanded || isMobileView ? 'mx-3 px-3 py-2' : 'mx-2 justify-center w-12 h-12'
          } hover:bg-white-1a`}
        >
          <svg
          ...
          {(isExpanded || isMobileView) && <span className="ml-2 text-sm">Wallet</span>}
        </Link>
